...
const AstroCard = ({ data, id }: { data: AstrologerType; id: number }) => {
  ...
  return (
    ...
    >
      {/* Image Section */}
      <div className="flex justify-center items-center w-[30%] sm:w-[20%] mr-2">
        <Image
...
//   const charge = calculate_charge({ charge: data.charge, discount: data.discount });
//   return (
//     <div className="w-full h-auto bg-white rounded-xl text-black flex items-center justify-between p-4 gap-4  shadow-[0px_1px_6px_0px_#0E233926]" key={id}>
//       <div className="flex justify-center items-center w-[20%] sm:w-[20%] m-2">
//         <Image
//           src={data.image || '/default-image.jpg'}
//           alt={data.name}
//           width={108}
...
//       <div className="w-[80%] flex justify-between items-start overflow-hidden">
//         <div className="flex flex-col justify-between items-start gap-2 w-[50%]">
//           <div className="flex justify-between items-center w-full">
...
//           </div>
//           <div className="font-normal text-sm text-[#0E233980] gap-2 w-[100%]">
//             <p className="truncate">{data.specialization.join(', ')}</p>
//             <p className="truncate">{data.languages.join(', ')}</p>
//             <p>Exp. {data.experience} Years</p>
//             {charge === 0 ? (
...
//           </div>
//         </div>
//         <div className="flex flex-col justify-between items-center w-[50%] h-full relative">
//           <div className="flex w-full justify-end">
//             <Verified className="text-green-500 text-xl" />
//           </div>
//           {data.status == true ?
...
//             <div className={`flex w-full justify-end absolute right-0 top-[65px]`}>
//               <div className='flex flex-col'>
//                 <Button className="text-red-400 bg-white border-red-400 border w-[6rem] font-bold hover:bg-red-400 hover:text-white" disabled>
//                   Chat
//                 </Button>
//                 <span className='text-red-400 text-[10px] text-center'>Wait - 7 min</span>
//               </div>
