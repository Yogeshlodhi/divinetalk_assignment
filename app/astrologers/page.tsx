...
//       <h1 className="hidden md:text-[48px] font-[400] text-center p-4">Chat with Astrologers</h1>
//       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-12 pt-0">
//         {AstroLogersData.map((astrologer: AstrologerType, index) => (
//           <AstroCard key={index} data={astrologer} id={index} />
//         ))}
//       </div>
